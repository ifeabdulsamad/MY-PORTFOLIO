...
const projects = [
  {
    ...
    description: "A website that tracks ip addresses",
  ...
  },
  {
    ...
    description: "A web based game built in react",
          ...
          <div className="flex justify-center gap-10 md:gap-14 mb-24">
            {categories.map((cat) => (
              <button
                ...
                className={`relative py-2 text-base md:text-lg font-medium transition-colors ${
