      ...
      <div className="container mx-auto md:px-12 ">
        ...
        >
          ...
          <p className=" text-center text-slate-400 text-lg leading-tight">
            Whether you have an idea, a project, or just want to talk tech — I’m
        ...
        <div className="w-full mx-auto">
          ...
          >
            <div className="glass p-10 rounded-3xl border border-slate-700/50 hover:border-primary/40 transition flex flex-col items-center text-center group">
              <div className="w-16 h-16 rounded-2xl  flex items-center justify-center text-primary mb-6 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                <Mail size={32} />
              </div>
